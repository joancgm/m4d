/* contains bijrhsmarv c_bijrhsmarv c_bijrhsmarvs */
#include "global.h"
...
void bijrhsmarv(FILE *fpin, FILE *fprint, double acapg)
/* in vki notes
 bij eqn source term =
...
{ 
  ...
  int i,j,k,n,ip[4],i4dp[4],i4dm[4],its,ite,mc[8],mmid,ia[3],ii[4],iall,iallm,ieq,nf,iter;
  int ix,jx;
  int two[3]={2,2,2};
  ...
  { 
    ...
    if (denom==0)  {capb=0; fb=0; c3=c3fdf; c4=c4fdf; c6=c6fdf;}
    else
    { 
...
{ double acapg=0.3;  
  bijrhsmarv(fpin,fprint,acapg);
}
void c_bijrhsmarvs(FILE *fpin, FILE *fprint)  
{ double acapg=0.244;  
  bijrhsmarv(fpin,fprint,acapg);
}